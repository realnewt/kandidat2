...
nExpID      = 'ZNH1';
nSaveID     = '21-05-06.mat';  % Contains T_save
nSample     = '21-05-06';
nRef        = 'H2O';

dt          = 5;                                 % Sampling time steps in [s]
texp        = 12;                                % Time for a single cooling/heating experiment in [h]
...
T_solid = [27 27.5];                % Ranges for average cp
T_liquid = [38 38.5];            
